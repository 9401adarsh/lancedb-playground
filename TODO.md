...
- [ ] Ensure you run each test mode for N times rather than just once. Write the logs to a file for better comprehension. Accept N as a user parameter. 
